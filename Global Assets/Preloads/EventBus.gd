...
signal Selection(playerSent:bool, action:int, option:int, detail:int)
signal AttackResults(target:BattlerData, results:Dictionary)
signal StatusResults(target:BattlerData, results:Dictionary, amount:int, type:Enums.Status)
signal HealthChanged(target:BattlerData, amount:int)
signal GuardChanged(target:BattlerData, magical:bool, active:bool)
